...
use IA\RegisterBundle\Entity\Organization;
use IA\RegisterBundle\Form\OrganizationType;
...
class OrganizationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IARegisterBundle:Organization')->findAll();
     ...
     * @Method("POST")
     * @Template("IARegisterBundle:Organization:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IARegisterBundle:Organization')->find($id);
     ...
     * @Method("PUT")
     * @Template("IARegisterBundle:Organization:edit.html.twig")
     */
